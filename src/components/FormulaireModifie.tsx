...
export default function FormulaireModifie() {
  const { personnageSelectionne } = useContext(PersonnageContext);

  const [nom, setNom] = useState(personnageSelectionne.nom);
  const [auteur, setAuteur] = useState(personnageSelectionne.auteur);
  const [apparitions, setApparitions] = useState(
    personnageSelectionne.apparitions
  );
  const [franchises, setFranchises] = useState(
    personnageSelectionne.franchises
  );
  const [description, setDesription] = useState(
    personnageSelectionne.description
  );
  const [principal, setPrincipal] = useState(
    personnageSelectionne.personnage_principal
  );
